...
<font style="color:white;background:mediumseagreen;padding:3px 6px;font-weight:bold;line-height:28px">git bash可以相当于linux命令行 特别好用</font>
...
<font style="color:white;background:mediumseagreen;padding:3px 6px;font-weight:bold;line-height:28px">注意cp -r复制文件夹名的两种情况：</font>

- 在源路径内打这个命令，会把目录内的所有内容复制到目标路径，<font style="color:white;background:mediumseagreen;padding:3px 6px;font-weight:bold;line-height:28px">而不复制源文件夹</font>(待定，可能报错no such file or directory)
- 在源路径外打这个命令，才可以把整个目录完整复制到目标路径，<font style="color:white;background:mediumseagreen;padding:3px 6px;font-weight:bold;line-height:28px">包括源文件夹</font>
...
- <font style="color:white;background:mediumseagreen;padding:3px 6px;font-weight:bold;line-height:28px">切记切记，使用rm -r在目录内是无法删除目录的！</font>
...
- ls后跟空格跟目录名，可看到那个目录下的内容
  ...
  <font style="color:white;background:mediumseagreen;padding:3px 6px;font-weight:bold;line-height:28px">这个目录名既可以是相对路径，也可以是绝对路径</font>
...
<font style="color:white;background:mediumseagreen;padding:3px 6px;font-weight:bold;line-height:28px">ln -s软链接命令和tree命令 windows系统不支持</font>
...
<font style="color:white;background:mediumseagreen;padding:3px 6px;font-weight:bold;line-height:28px">sh命令可以执行xxx.sh文件也可以执行xxx.txt文件</font>
...
<font style="color:white;background:mediumseagreen;padding:3px 6px;font-weight:bold;line-height:28px">若某个命令例如cp，想用新的网上下载的工具代替系统的，只需要将下载工具的环境变量顶在系统自带cp的环境变量前，即可先找到他，就默认使用它了。</font>
...
<font style="color:white;background:mediumseagreen;padding:3px 6px;font-weight:bold;line-height:28px">注意路径，windows要使用"\"，linux使用"/"</font>
